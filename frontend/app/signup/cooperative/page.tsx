...
import { Building2, ArrowRight, ShieldCheck, AlertCircle, MapPin, Loader2 } from "lucide-react";
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2.5 pr-36 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-500 text-sm"
              />
              <button
                type="button"
                onClick={() => detectLocation((addr) => setAddress(addr))}
                disabled={isLocating}
                className="absolute right-1.5 top-1.5 bottom-1.5 px-3 rounded-lg bg-indigo-50 hover:bg-indigo-100 border border-indigo-200 text-indigo-700 text-[11px] font-semibold flex items-center gap-1.5 transition disabled:opacity-60"
              >
